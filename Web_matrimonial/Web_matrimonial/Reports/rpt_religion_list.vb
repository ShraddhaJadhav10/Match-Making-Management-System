...
Public Class rpt_religion_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Web_matrimonial.rpt_religion_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_religion_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_religion_list = New rpt_religion_list
        rpt.Site = Me.Site
        Return rpt
    End Function
