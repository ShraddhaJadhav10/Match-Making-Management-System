...
Public Class rpt_cast_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Web_matrimonial.rpt_cast_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cast_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cast_list = New rpt_cast_list
        rpt.Site = Me.Site
        Return rpt
    End Function
