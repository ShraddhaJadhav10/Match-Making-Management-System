...
Public Class rpt_education_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Web_matrimonial.rpt_education_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_education_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_education_list = New rpt_education_list
        rpt.Site = Me.Site
        Return rpt
    End Function
