...
Public Class rpt_profile_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Web_matrimonial.rpt_profile_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_profile_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_profile_list = New rpt_profile_list
        rpt.Site = Me.Site
        Return rpt
    End Function
