...
Partial Public Class Web_Search_byReligion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            DropDownList1.DataValueField = "rel_id"
            DropDownList1.DataTextField = "rel_nm"
    ...
    Protected Sub btn_search_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_search.Click
        Dim cnt As Integer
        cmd = New SqlCommand("SELECT * from Member_profile where rel_id=" & DropDownList1.SelectedValue, cn)
        dr = cmd.ExecuteReader
        While dr.Read
            cnt = cnt + 1
        End While
        ...
        lit1.Text = "<table border=1 width='100%'>"
        lit2.Text = "<tr>"
