<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Web_Admin_Login.aspx.vb" Inherits="Web_matrimonial.Web_Admin_Login" %>
 ...
 <section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - January 23, 2012!</div>
        <div class="main">
            <div class="wrapper">
                ...
                <article class="col-2">
                	<h3 class="style2" align="center">Admin Login</h3>
    ...
    <table align=center width=100% >
        <tr>
            <td align="right" class="style4">
                <asp:Image ID="Image1" runat="server" Height="100px" 
                    ImageUrl="~/catering/images/prettyPhoto/default/admin.png" />
            </td>
            <td align="right" class="style3">
                Admin&nbsp; Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
            <td>
                <asp:TextBox ID="txt_admin_Login_nm" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right" class="style4">
            ...
            <td align="right" class="style3">
                Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;             </td>
            <td>
                <asp:TextBox ID="txt_admin_pass" runat="server" TextMode="Password"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="center" class="style2" colspan="2">
                <asp:Button ID="btn_login" runat="server" Height="31px" Text="Login" 
                    Width="110px"   ForeColor="White" 
                        AutoGenerateSelectButton="True" BackColor="#E24502" 
                    BorderColor="#E04701" 
                    style="color: #FFFFFF; font-size: large; font-weight: 700"/>
            </td>
        </tr>
    </table>
    <div>
