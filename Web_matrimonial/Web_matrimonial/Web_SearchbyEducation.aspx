<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Web_SearchbyEducation.aspx.vb" Inherits="Web_matrimonial.Web_SearchbyEducation" %>
 ...
 <section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - January 23, 2012!</div>
        <div class="main">
            <div class="wrapper">
                ...
                <h3 class="style2" align="center"> <b>Filter</b> <b>By</b> <b>Education</b> </h3>
        ...
        <table class="style1">
            <tr>
                <td class="style2" align="right">
                    <span class="style3">Select Education&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server">
                    </asp:DropDownList>
                    <asp:Button ID="btn_search" runat="server" Text="Search" Width="110px"  BackColor="#E24502" 
