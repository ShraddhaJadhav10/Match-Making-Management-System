<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Web_Education.aspx.vb" Inherits="Web_matrimonial.Web_Education" %>
...
<head>
	...
	function formValidator(){
      ...
      var txt_Education_nm = document.getElementById("txt_Education_nm");
      var txt_Education_id = document.getElementById("txt_Education_id");
       if(notEmpty(txt_Education_nm,"enter nm") && isAlphabet(txt_Education_nm,"Enter only Alphabet"))
      {
        return true;
      }
      return false;
    ...
    Board</asp:HyperLink>
        ...
        <div class="main">
            <div class="wrapper">
                ...
                <article class="col-2">
                	<h3 class="style2" align="center">Education&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3>
        ...
        <table class="style1">
            <tr>
                ...
                <td align="right" class="style3">
                    Education ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td class="style4">
                    <asp:TextBox ID="txt_Eduction_id" runat="server" Enabled="False"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td align="right" class="style3">
                    Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td class="style4">
                    <asp:TextBox ID="txt_Education_nm" runat="server"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                <td align="center" colspan="4">
                    ...
                    <asp:Button ID="btn_show" runat="server" Text="Show All"     BackColor="#E24502" 
                        Font-Bold="True" Font-Size="Large" ForeColor="White" Width="93px"  />
                    <asp:Button ID="btn_search" runat="server" Text="Search"   BackColor="#E24502" 
                        Font-Bold="True" Font-Size="Large" ForeColor="White" Width="73px"  />
                </td>
            </tr>
            <tr>
                <td align="center" colspan="4">
            ...
            <tr>
                <td align="center" colspan="4">
                    <asp:GridView ID="GridView1"   style="border:solid 2px orangeRed;" runat="server" Width="259px"  ForeColor="black" 
