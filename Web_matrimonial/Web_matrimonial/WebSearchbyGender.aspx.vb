...
Partial Public Class WebSearchbyGender
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            cmd.Connection = cn
            cmd.CommandText = "select * from Member_profile "
    ...
    Protected Sub btn_search_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_search.Click
        Dim cnt As Integer
        cmd = New SqlCommand("SELECT * from Member_profile where Gender='" & DropDownList1.SelectedValue & "'", cn)
        dr = cmd.ExecuteReader
        While dr.Read
            cnt = cnt + 1
        End While
