<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebSearchbyGender.aspx.vb" Inherits="Web_matrimonial.WebSearchbyGender" %>
 ...
 <section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - January 23, 2012!</div>
        <div class="main">
            <div class="wrapper">
                ...
                <h3 class="style2" align="center"> <b>Filter By Gender</b> </h3>
    <div>
    ...
    <table class="style1">
        <tr>
            <td class="style2" align="right">
                <span class="style3">Select Gender&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
            <td>
                ...
                <asp:Button ID="btn_search" runat="server" Text="Search" Width="109px" BackColor="#E24502" 
